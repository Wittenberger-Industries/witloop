...
- [Ship verification honesty](learnings/0003-blast-radius-proof.md): WHEN adding a second coverage table to the checker → AVOID placing it before the bug-fix matrix; reinforces 0003-work-type-routing's serial-wiring hook
