...
- [Marketplace plugin descriptions under 1024 chars](learnings/0005-marketplace-json-cap.md): WHEN judging a validate.py repro → AVOID treating exit 1 as the named bug
