...
- [/wit-setup first-run](learnings/0004-setup.md): WHEN a new advertised command takes over first-run copy → DO retarget README cells, manifests, and the old alias in the same sitting
