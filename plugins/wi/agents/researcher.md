...
3. **Look outward only as needed.** If the choice hinges on an unfamiliar library or technique, check its
   current docs/maintenance/fit (WebSearch/WebFetch). Don't research what the repo already answers.
4. **Compare honestly.** Weigh 2-3 real options on complexity, blast radius, reversibility, maintenance,
   and fit with the constitution. Note the genuine tradeoffs — not strawmen.
5. **Decide.** Recommend exactly one approach and say why it wins. If it's a close call or hard to
...
Risks / unknowns: <what could bite; what to verify during build>
